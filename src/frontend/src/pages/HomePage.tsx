  ...
  return (
    <div>
      ...
      <section
        ...
        style={{ background: "oklch(0.12 0.02 30)" }}
      >
        {/* Halftone background */}
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle, oklch(0.88 0.18 90 / 0.15) 2px, transparent 2px)",
        ...
        <div className="relative z-10 container mx-auto px-4 py-16 md:py-24 text-center">
          ...
          <div className="mb-4">
            <h1
              ...
              style={{
                ...
                textShadow:
                  "6px 6px 0px oklch(0.52 0.22 25), 10px 10px 0px oklch(0.12 0.02 30 / 0.5)",
          ...
          <p className="font-comic text-comic-yellow/80 text-lg mb-10 max-w-xl mx-auto">
            Bold. Funny. Outrageous. Dive into our collection of PG-13 comic
            strips that'll make you laugh out loud!
          </p>
            ...
            {[
              {
                icon: "📚",
                label: "Comics",
                value: isLoading ? "..." : String(comics?.length ?? 0),
              },
      ...
      <div
        className="relative overflow-hidden"
        style={{
          borderTop: "4px solid oklch(0.12 0.02 30)",
          borderBottom: "4px solid oklch(0.12 0.02 30)",
        }}
      >
        <img
        ...
        <div className="container mx-auto px-4">
          ...
          {isLoading ? (
                ...
                <div>
                  ...
                  <h3
                    ...
                    style={{
                      ...
                      textShadow: "3px 3px 0px oklch(0.88 0.18 90)",
                    }}
                  >
                    {comics[0].title}
                  </h3>
            ...
            <div className="text-center py-12">
              <p className="font-bangers text-3xl text-muted-foreground">
            ...
            {[
              {
                emoji: "💥",
                title: "BOLD HUMOR",
                desc: "Outrageous comedy that pushes the limits of PG-13 fun!",
              },
              {
                emoji: "🎨",
                title: "COMIC ART",
                desc: "Vibrant, expressive art that leaps off the page!",
              },
              {
                emoji: "⚡",
                title: "NEW STRIPS",
                desc: "Fresh comic strips added regularly to keep you laughing!",
              },
            ].map((item) => (
              <div
                key={item.title}
