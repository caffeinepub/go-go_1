...
const COVER_IMAGES: Record<string, string> = {
  '1lWnWT1t5nKmRcQhQdWLtfLf4ew7CCjRie_eVSU363a4': '/assets/generated/comic-cover-legends.dim_400x300.png',
};
          ...
          {isLoading ? (
            ...
            <div className="text-center py-16">
              <div
                ...
                style={{ border: '4px solid oklch(0.12 0.02 30)', boxShadow: '6px 6px 0px oklch(0.12 0.02 30)' }}
              >
            ...
            <>
              <div className="mb-6 flex items-center gap-3">
                ...
                >
                  {comics.length} COMIC{comics.length !== 1 ? 'S' : ''} AVAILABLE
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
