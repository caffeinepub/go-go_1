        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-comic-red" style={{ border: '1.5px solid oklch(0.12 0.02 30)' }} />
                <div className="w-3 h-3 rounded-full bg-comic-yellow" style={{ border: '1.5px solid oklch(0.12 0.02 30)', background: 'oklch(0.7 0.15 90)' }} />
                <div className="w-3 h-3 rounded-full" style={{ border: '1.5px solid oklch(0.12 0.02 30)', background: 'oklch(0.65 0.18 145)' }} />
              </div>
          ...
          <div className="mt-6 text-center">
            <div
              ...
              style={{ border: '3px solid oklch(0.12 0.02 30)', boxShadow: '4px 4px 0px oklch(0.12 0.02 30)' }}
            >
              <p className="font-comic font-bold text-comic-ink text-sm">
                💡 <strong>TIP:</strong> Use the arrow keys or click the arrows in the slides to navigate panels!
              </p>
            </div>
          </div>
