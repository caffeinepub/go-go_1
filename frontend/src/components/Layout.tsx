        ...
        <div className="relative z-10 container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2">
            <Link
              ...
              style={
                isHome
                  ? { border: '2px solid oklch(0.88 0.18 90)', boxShadow: '3px 3px 0px oklch(0.88 0.18 90)' }
            ...
            <Link
              to="/catalog"
              className={`flex items-center gap-1.5 font-bangers text-lg px-3 py-1.5 transition-all ${
                location.pathname === '/catalog' || location.pathname.startsWith('/reader')
                  ? 'bg-comic-yellow text-comic-ink'
                  : 'text-comic-yellow hover:bg-comic-yellow/20'
              }`}
              style={
          ...
          >
            ...
            <span className="font-bangers text-comic-yellow text-sm tracking-wider">PG-13</span>
          </div>
        </div>
      </header>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <p className="font-comic text-comic-yellow/50 text-xs mt-1">
                ...
                <a
                  href={`https://caffeine.ai/?utm_source=Caffeine-footer&utm_medium=referral&utm_content=${encodeURIComponent(
                    typeof window !== 'undefined' ? window.location.hostname : 'gogo-comics'
                  )}`}
                  target="_blank"
            ...
            <div className="flex gap-3">
              <div
                ...
                style={{ border: '2px solid oklch(0.88 0.18 90)' }}
              >
                <span className="font-bangers text-comic-yellow text-sm">PG-13</span>
              </div>
              <div
                className="bg-comic-yellow px-3 py-1"
                style={{ border: '2px solid oklch(0.88 0.18 90)' }}
              >
                <span className="font-bangers text-comic-ink text-sm">COMICS</span>
              </div>
            </div>
          </div>
        </div>
